...
public class shebeichaweibaoneirong extends Activity {
...
//				}); 
    ...
    //����nameֵ
    cxnr = bundle.getString("xiangxide");
  ...
  class weibaoxiangqingThread extends Thread {
    public void run() {
      ...
      try {
        ...
        Intent intent = new Intent(shebeichaweibaoneirong.this, weibaoxiangqinglist.class);
        ////����
