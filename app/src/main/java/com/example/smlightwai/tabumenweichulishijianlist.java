...
public class tabumenweichulishijianlist extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    btn_back.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        ...
        Intent intent = new Intent(tabumenweichulishijianlist.this, shijian_page2.class);
    ...
    lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
      ...
      public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Intent intent = new Intent(tabumenweichulishijianlist.this, shijianzhipai.class);  //?????????
        ////����
