...
import com.example.smlightwai.baojingboth.baojingThread;
...
public class guzhangneirong extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    btn_back.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        if(Utils.isFastClick()) {
          Intent intent = new Intent(guzhangneirong.this, shebeibaojinglist.class);
    ...
    try {
      ...
      jo = new JSONObject(bundle.getString("shebeibaojingxaingxixinxi"));
    ...
    public void run() {
      try {
        ...
        if(resStr.equals("true")) {
          Looper.prepare();
          Toast.makeText(guzhangneirong.this, "���ȷ�ϣ���", Toast.LENGTH_LONG).show();
          Looper.loop();
          return;
        } else {
          Looper.prepare();
          Toast.makeText(guzhangneirong.this, "ȷ��ʧ�ܣ������²�������", Toast.LENGTH_LONG).show();
          Looper.loop();
          return;
        }
