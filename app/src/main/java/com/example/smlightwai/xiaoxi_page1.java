...
import com.example.smlightwai.xiaoxi_page2.renyuanThread;
...
public class xiaoxi_page1 extends Activity implements View.OnClickListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    View xiaoxiguanli = inflater.inflate(R.layout.xiaoxigerenfenlei, null);
      ...
      public void onClick(View v) {
        ...
        try {
          ...
          if(Loginpage.yhjo.getString("organizationId").equals("2")) {
            intent = new Intent(xiaoxi_page1.this, Roleshichang.class);
            startActivity(intent);

          } else if(Loginpage.yhjo.getString("organizationId").equals("3")) {
            intent = new Intent(xiaoxi_page1.this, Roleanbao.class);
            startActivity(intent);

          } else if(Loginpage.yhjo.getString("organizationId").equals("4")) {
            intent = new Intent(xiaoxi_page1.this, Roleengineer.class);
            startActivity(intent);

          } else if(Loginpage.yhjo.getString("organizationId").equals("5")) {
            intent = new Intent(xiaoxi_page1.this, Rolecehua.class);
            startActivity(intent);

          } else if(Loginpage.yhjo.getString("organizationId").equals("6")) {
            intent = new Intent(xiaoxi_page1.this, Rolexingzheng.class);
            startActivity(intent);

          } else if(Loginpage.yhjo.getString("organizationId").equals("7")) {
            intent = new Intent(xiaoxi_page1.this, Rolekefu.class);
            startActivity(intent);

          } else if(Loginpage.yhjo.getString("organizationId").equals("8")) {
            intent = new Intent(xiaoxi_page1.this, Rolezongjingli.class);
            startActivity(intent);
          }
    ...
    btn_fasongxiaoxi.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        if(Utils.isFastClick()) {
          ...
          mWeiboDialog = WeiboDialogUtils.createLoadingDialog(xiaoxi_page1.this, "������...");
    ...
    public void run() {
      ...
      try {
        ...
        if(btnflag.equals("release")) {
          ...
          Intent intent = new Intent(xiaoxi_page1.this, Xiaoxi_gerenxiaoxizhuangtailist.class);

          Bundle bundle = new Bundle();
          //����name����Ϊtinyphp
          bundle.putString("gerenfabuxiaoxichakanlist", resStr);
          bundle.putString("xiaoxijiemian", "xiaoxi_page1");
          intent.putExtras(bundle);

          startActivity(intent);

        } else if(btnflag.equals("message")) {
          Intent intent = new Intent(xiaoxi_page1.this, jieshouxiaoxilist.class);
  ...
  class renyuanThread extends Thread {
    public void run() {
      ...
      try {
        ...
        Intent intent = new Intent(xiaoxi_page1.this, bumenrenyuanlist.class);

        Bundle bundle = new Bundle();
        //����name����Ϊtinyphp
        bundle.putString("bumenrenyuan", resStr);
        bundle.putString("jiemiana", "1");


        Log.d("vdfdfd", "redsdadadsStr");
        intent.putExtras(bundle);
        ////����
        startActivity(intent);
      } catch(MalformedURLException e) {
