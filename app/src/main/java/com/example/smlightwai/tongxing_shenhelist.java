...
public class tongxing_shenhelist extends Activity {
  private ListView lv;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    btn_back.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
        if(Utils.isFastClick()) {
          Intent intent = new Intent(tongxing_shenhelist.this, tongxing_bothguanli.class);
    ...
    lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
      ...
      public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        if(Utils.isFastClick()) {
          Intent intent = new Intent(tongxing_shenhelist.this, tongxing_shenheneirong.class);  //?????????
          ////����
    ...
    String shijianlist = "{\"txsslist\":" + bundle.getString("tongxingshenhelist") + "}";
    try {
      JSONObject jo = new JSONObject(shijianlist);
      //����豸����list
      ja = jo.getJSONArray("txsslist");
      int n = ja.length();
